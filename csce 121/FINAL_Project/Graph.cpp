...
Suffix::Encoding get_encoding(const string& s)
{
    ...
    static SuffixMap smap[] = {
        {".jpg",  Suffix::jpg}, {".JPG",  Suffix::jpg},
        {".jpeg", Suffix::jpg}, {".JPEG", Suffix::jpg},
        {".gif",  Suffix::gif}, {".GIF",  Suffix::gif},
		{".png",  Suffix::png}, {".PNG",  Suffix::png},
		{".bmp",  Suffix::bmp}, {".BMP",  Suffix::bmp},
    };
...
{
	Fl_Image* pp = p->copy(350,350);//resize image 
	
    if (fn.label()!="") fn.draw_lines();
	
    if (w&&h)
        pp->draw(point(0).x,point(0).y,w,h,cx,cy);
    else
		pp->draw(point(0).x,point(0).y);
}
