...
class Smiley : public Circle {
	...
	Point smile_end() const;
	
	Smiley(Point p, int rr)
		:Circle(p,rr)
		{
			eye1.add (Point (center().x-35,center().y-20));
			eye1.add (Point (center().x-45,center().y-40));
			eye1.add (Point (center().x-35,center().y-60));
			eye1.add (Point (center().x-25,center().y-40));
			
			eye2.add (Point (center().x+35,center().y-20));
			eye2.add (Point (center().x+45,center().y-40));
			eye2.add (Point (center().x+35,center().y-60));
			eye2.add (Point (center().x+25,center().y-40));
			
			smile1.add(Point (center().x-30,center().y+20), Point (center().x-0,center().y+70));
			smile1.add(Point (center().x+30,center().y+20), Point (center().x+0,center().y+70));
		}
...
class S_Hat : public Smiley {
	public:
	Polygon party_hat;
	
	Point smile_end() const;
	
	S_Hat(Point p, int rr)
		:Smiley(p,rr)
		{
			party_hat.add (Point (center().x,center().y-170));	
			party_hat.add (Point (center().x-20,center().y-100));	
			party_hat.add (Point (center().x+20,center().y-100));
		}
...
class Frowny : public Circle {
	...
	Frowny(Point p, int rr)
		:Circle(p,rr)
		{
			...
			smile1.add(Point (center().x+30,center().y+70), Point (center().x-0,center().y+20));
			smile1.add(Point (center().x-30,center().y+70), Point (center().x+0,center().y+20));
		}
...
class F_Hat : public Frowny {
	...
	F_Hat(Point p, int rr)
		:Frowny(p,rr)
		{
			...
			feather.add (Point (center().x-30,center().y-150));	
			feather.add (Point (center().x-20,center().y-170));	
			feather.add (Point (center().x-20,center().y-100));	
			feather.add (Point (center().x-40,center().y-150));	
