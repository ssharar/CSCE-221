...
public:
  ...
  T& getElem() { return obj; };		//ADDED FOR SPARSEMATRIX TO WORK!!
  DListNode<T> * getNext() const { return next; }
  DListNode<T> * getPrev() const { return prev; }
  

//ADDED FOR SPARSEMATRIX TO WORK!!
  //DListNode<T>* insert_before(T d); // insert the elem before this node
                                // return a pointer to the inserted node

// insert the int before this node
// return a pointer to the inserted node
//BIG OH = O(1)
   DListNode<T>* insert_before(T d) {
    ...
    u->next = this;
    u->prev = this->prev;
    this->prev->next = this->prev = u;
    
  }



 /* DListNode<T>* insert_after(T d); // insert the elem after this node
                               // return a pointer to the inserted node
